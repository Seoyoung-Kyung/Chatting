...
public class ServerThread extends Thread {
	...
	private ChatRoom st_chatRoom;
	private ChatRoom var12;
	public String st_ID;
	...
	public Socket getClientSocket(Socket var1) {
        return var1;
    }
	...
	private void send(String var1) throws IOException {
		DataOutputStream var2 = this.st_out;
	...
	private synchronized void broadcast(String var1, int var2) throws IOException { // 메시지, 방 번
	...
	private synchronized void broadcast2(String var1, int var2, ServerThread st) throws IOException { // 메시지, 방 번
		Hashtable var4 = this.st_waitRoom.getClients(var2);
		Enumeration var5 = var4.keys();
			...
			while (true) {
				...
				switch (var3) {
					...
					case 1011 :
						...
						var12 = new ChatRoom(var22, var27, var29, var6, var4);
						...
						break;
					case 1021 :
						var4 = var20.nextToken(); // 아이디  
						int var25 = Integer.parseInt(var20.nextToken()); // 방 번호 

						try {
							var22 = var20.nextToken(); // 방 비밀번호 
					...
					case 1071 :
						...
						var5 = Integer.parseInt(var20.nextToken());
						var6 = var20.nextToken();
						var8 = this.st_waitRoom.getUser(var6);
						if (var8 != null) {
							this.st_buffer.setLength(0);
							this.st_buffer.append(1071);
							this.st_buffer.append("|");
							this.st_buffer.append(var4);
							this.st_buffer.append("|");
							this.st_buffer.append(this.st_roomNumber);
						...
						break;
					case 1081 :
						var4 = var20.nextToken(); // ID 
						var5 = Integer.parseInt(var20.nextToken()); // 방 번호 
						var6 = var20.nextToken(); // 선택 받은 사용자 ID 
						...
						if (var8 != null) {
							if(var4.equals(var6)) {
								this.st_buffer.setLength(0);
								this.st_buffer.append(2082);
								this.st_buffer.append("|");
								this.st_buffer.append(var4);
								this.st_buffer.append("|");
								this.st_buffer.append(var5);
								this.st_buffer.append("|");
								this.st_buffer.append(var6);
								this.st_buffer.append("|");
								this.st_buffer.append("Yes");
								this.st_buffer.append("|");
								this.st_buffer.append(var8);
								var8.send(this.st_buffer.toString());
							} else {
								this.st_buffer.setLength(0);
								this.st_buffer.append(2081);
								this.st_buffer.append("|");
								this.st_buffer.append(var4);
								this.st_buffer.append("|");
								this.st_buffer.append(var5);
								...
								this.st_buffer.append("|");
								this.st_buffer.append(var8);
								this.broadcast2(this.st_buffer.toString(), var5, var8);
								//this.broadcast2(this.st_buffer.toString(), var5);
							}
							// var8.send(this.st_buffer.toString());
						} else {
							this.st_buffer.setLength(0);
					...
					case 2062 :
						...
						var8.send(this.st_buffer.toString());
					case 2071 :
						var4 = var20.nextToken(); // 초대 받을 사람
						var5 = Integer.parseInt(var20.nextToken()); // 방 번호
						var6 = var20.nextToken(); // 초대한 사람  
						var8 = this.st_waitRoom.getUser(var4); // 초대 받을 사람의 ServerThread 
						...
						var27 = this.st_waitRoom.joinRoom(var4, var8, var5, var22);
						// String id, ServerThread client,int roomNumber, String password
						if (var27 == 0) {
							this.st_buffer.setLength(0);
							this.st_buffer.append(2021);
							this.st_buffer.append("|");
							...
							this.st_buffer.append("|");
							this.st_buffer.append(var4);
							this.st_roomNumber = var5;
							this.send(this.st_buffer.toString());
							this.modifyRoomUser(var5, var4, 1);
							this.modifyWaitRoom();
						} else {
							this.sendErrCode(2022, var27);
						}
					...
					case 2072 :
						...
						var6 = var20.nextToken();
						var8 = null;
						var8 = this.st_waitRoom.getUser(var4);
						this.st_buffer.setLength(0);
						this.st_buffer.append(2072);
						this.st_buffer.append("|");
						this.st_buffer.append(3031);
