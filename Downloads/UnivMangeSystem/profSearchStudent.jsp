...
<div class="topnav">    
  ...
  <div style="width:100%; float:center;">
    <h3 style="font-weight:bold;">&nbsp; 담당 학급
    <a href ="profClass.jsp"><i class="fas fa-arrow-left" style="font-size:28px; color:rgb(54, 54, 54); float:right;">&nbsp;&nbsp;&nbsp;</i></a>
    </h3><hr>
  </div>
...
<%
	...
	try {
		...
		String sql = "select s.s_photo,p.prof_name, s.s_id, s.s_name, s.s_tel, s.s_email, s.s_address, s.s_grade, s.s_class, s.dept_id,s.s_state from student s inner join professor p on s.prof_id = p.prof_id where s.dept_id=? and "+sk+"=? order by s_grade, s_class, s_id";
