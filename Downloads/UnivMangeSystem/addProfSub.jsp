...
<div style="width:100%; float:center;">
  ...
  &nbsp;
	...
	try {
		...
		String sql = "select distinct sub_id, sub_name from subject where dept_id= ?";
...
%>
        <option value="<%=sub_id%>"><%=sub_id%> / <%=sub_name%></option>
<%  } 
}catch(Exception e){
	e.printStackTrace();
}finally{
