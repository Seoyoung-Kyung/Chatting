...
<div class="topnav">    
  ...
  <div style="width:100%; float:center;">
    <h3 style="font-weight:bold;">&nbsp; 학생 정보
  ...
  <select id="sk" name="sk">
    ...
    <option value="prof_name">담당 교수</option>
	</select>
  ...
  <table class="type11">
        ...
        <th scope="cols" width=60>학년</th>
        <th scope="cols" width=60>반</th>
...
<%
	...
	try {
		...
		String sql = "select s.s_photo,p.prof_name, s.s_id, s.s_name, s.s_tel, s.s_email, s.s_grade, s.s_class, s.dept_id,s.s_state from student s inner join professor p on s.prof_id = p.prof_id where s.dept_id=? and "+sk+"=? order by s_grade, s_class, s_id";
