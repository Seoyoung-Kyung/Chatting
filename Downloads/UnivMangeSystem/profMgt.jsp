...
<div class="topnav">    
  ...
  <div class="card" style="overflow:scroll; height:600px; overflow-x: hidden;">
  <div style="width:100%; float:center;">
    <h3 style="font-weight:bold;">&nbsp; 교수 정보</h3><hr>
  </div>
...
&nbsp;
      ...
      <a href ="addProf.jsp"><i class="fas fa-user-plus" style="font-size:28px; color:rgb(54, 54, 54); float:right;">&nbsp;&nbsp;&nbsp;</i></a>
</form>
<table class="type11">
		<thead>
			<tr>
...
<%
	...
	try {
		...
		String sql = "select dept_id, prof_id, prof_name, prof_tel, prof_email, prof_state, prof_photo from professor where dept_id=? order by dept_id, prof_id";
	...
	%>
      <tr>
        ...
        <td><%=prof_state%></td>
        <td>
          <a href ="profMgtForm.jsp?prof_id=<%=prof_id%>&prof_name=<%=prof_name%>&prof_tel=<%=prof_tel%>&prof_email=<%=prof_email%>"><i class="fas fa-user-cog" style="color:rgb(107, 107, 107)"></i></a>
        </td>
			</tr>
<%  } 
}catch(Exception e){
