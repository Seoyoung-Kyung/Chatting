...
<div class="card" style="height:394px; overflow: scroll; overflow-x: hidden">
  <div><h3 class='blue'><b>&nbsp; 성적 입력</b></h3><hr></div>
  ...
  <table>
        <thead>
         ...
         <tr>
            ...
            <td><%=sub_id%></td>
            <td><%=prof_id%></td>
            <td><a href="otherscoreInsert.jsp?s_id=<%=s_id%>&s_name=<%=s_name%>&sub_id=<%=sub_id%>" class="btn btn-light btn-sm"><i class="fas fa-pen-square fa-lg" style="color:lightblue"></i></a></td>
          </tr>
