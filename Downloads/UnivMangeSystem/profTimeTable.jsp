...
<body style="overflow-x: hidden">
  ...
  String sql = "select s.sub_id, s.sub_name, s.sub_time, s.sub_info from subject s inner join prof_subject ps on s.sub_id=ps.sub_id inner join professor p on ps.prof_id=p.prof_id where p.prof_id=? and semester='2'";
...
<div class="card" style="height:394px; overflow: scroll;">
  <div style="width:100%;">
  <h3 class='blue'><b>&nbsp; 강의 시간표>> 2학기</b></h3><hr></div>
  <div style="margin-left: 1px;">
    <a href="profTimeTable_1.jsp"><button id="input2">1학기</button></a>
    <a href="profTimeTable.jsp"><button id="input2"><b>2학기</b></button></a>
</div>
  <table>
          <thead>
               <tr>
