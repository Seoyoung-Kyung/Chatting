...
<div class="card" style="overflow:scroll; height:440px; overflow-x: hidden;">
<div style="width:100%; float:center;">
    <h3 style="font-weight:bold;">&nbsp; 학과 정보</h3><hr>
  </div>
...
<%
   ...
   try {
      ...
      while(rs.next()){
         ...
         String dept_tel = rs.getString("dept_tel");
  ...
  <a href="deptUpdate.jsp?dept_id=<%=dept_id%>&dept_name=<%=dept_name%>&dept_tel=<%=dept_tel%>&dept_location=<%=dept_location%>"><button id="input2">수정</button></a>
</div>
</div>
  <div class="footer">
