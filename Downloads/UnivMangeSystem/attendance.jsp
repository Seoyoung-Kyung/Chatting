  ...
  <table>
        <thead>
         ...
         <tr>
            ...
            <td><%=sub_id%></td>
            <td><%=prof_id%></td>
            <td><a href="attendanceInsert.jsp?s_id=<%=s_id%>&s_name=<%=s_name%>&sub_id=<%=sub_id%>" class="btn btn-light btn-sm"><i class="fas fa-pen-square fa-lg" style="color:lightblue"></i></a></td>
          </tr>
