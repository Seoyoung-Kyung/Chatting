...
<body style="overflow-x: hidden">
  ...
  String sql = "select a.prof_id, a.sub_id, b.sub_name from prof_subject a inner join subject b on(a.sub_id=b.sub_id) where a.prof_id=?";
...
<div class="card" style="overflow: scroll; overflow-x: hidden">
  ...
  <table>
        <thead>
               ...
               <th scope="cols">시험성적입력</th>    
               <th scope="cols">출석성적입력</th>   
               <th scope="cols">기타성적입력</th>
         </tr>
        </div>
         <%
            while (rs.next()) {
         ...
         <tr>
            ...
            <td><%=sub_id%></td>
            <td><%=sub_name%></td>
            <td><a href="registration.jsp?sub_id=<%=sub_id%>"><i class="fas fa-pen-square fa-lg" style="color:lightblue"></i></a></td>
            <td><a href="attendance.jsp?sub_id=<%=sub_id%>"><i class="fas fa-pen-square fa-lg" style="color:lightblue"></i></a></td>
            <td><a href="otherscore.jsp?sub_id=<%=sub_id%>"><i class="fas fa-pen-square fa-lg" style="color:lightblue"></i></a></td>
          </tr>
