...
<div class="topnav">    
    <img src="logo.jpg">
      <ul id ="fromInsideOut" style="font-weight:bold;">
          ...
          <li><a href="deptProfSub.jsp" class="active">과목별 담당 교수 </a></li>
         <a href="Logout.jsp" class="signup">Logout</a>
        </ul>
</div>
  <div class="card" style="overflow:scroll; height:500px;">
  <div style="width:100%; float:center;">
    <h3 style="font-weight:bold;">&nbsp; 과목별 담당 교수 정보
    <a href ="deptProfSub.jsp"><i class="fas fa-arrow-left" style="font-size:28px; color:rgb(54, 54, 54); float:right;">&nbsp;&nbsp;&nbsp;</i></a>
    </h3><hr>
  </div>
...
<%
	...
	try {
		...
		String sql = "select ps.sub_id ,s.sub_name ,p.prof_name ,ps.prof_id from prof_subject ps inner join professor p on ps.prof_id=p.prof_id inner join subject s on ps.sub_id=s.sub_id inner join department d on d.dept_id=s.dept_id where d.dept_id=? and "+sk+"=? order by p.prof_id, s.sub_id";
