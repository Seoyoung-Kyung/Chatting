...
<div class="card" style="overflow: scroll; overflow-x: hidden">
  <h3 class='blue'><b>&nbsp; 중간성적 입력</b></h3><hr>

  <table>
    <form method="post" action="middlescoreInsertPro.jsp?s_id=<%=s_id%>&sub_id=<%=sub_id%>">
        <tr>
          <th scope="row">학번</th>
          <td><%=s_id%></td>
        </tr>
        ...
        <tr>
          <th scope="row">중간성적</th>
          <td><input type="number" max="35"id="middle_score" name="middle_score" placeholder="35점 만점" autocomplete="off" required></td>
        </tr>
        <tr>
          <th scope="row">버튼</th>
