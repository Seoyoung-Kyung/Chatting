...
<div class="card" style="overflow: scroll; overflow-x: hidden">
  <h3 class='blue'><b>&nbsp; 기타점수 입력</b></h3><hr>

  <table>
      <thead>
        <tr>
          <form method="post" action="otherscoreInsertPro.jsp?s_id=<%=s_id%>&sub_id=<%=sub_id%>">
          <th scope="row">학번</th>
          <td><%=s_id%></td>
        </tr>
        <tr>
        ...
        <tr>
          <th scope="row">기타성적</th>
          <td><input type="number" max="10" id="other_score" name="other_score" placeholder="10점 만점" autocomplete="off" required></td>
        </tr>
        <tr>
          <th scope="row">버튼</th>
