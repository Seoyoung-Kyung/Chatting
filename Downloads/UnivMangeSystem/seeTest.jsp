...
<body style="overflow-x: hidden">
  ...
  String sql = "select s.s_photo, s.s_id, s.s_grade, s.s_class, s.s_name, st.sub_name, r.middle_score, r.final_score, r.attendance, r.other_score, r.attendance, r.other_score from registration r inner join student s on r.s_id=s.s_id inner join subject st on r.sub_id = st.sub_id where r.prof_id=?";
...
<div class="card" style="height:394px; overflow: scroll; overflow-x: hidden">
  <div><h3 class='blue'><b>&nbsp; 전체성적 열람</b></h3><hr></div>
  <div>
  <button type="button" onClick="location.href='seeScore.jsp'">&nbsp; 총점 / 평점 / 반별성적</button>
  <form action="scoreSearch.jsp" method="post" style="float:left; margin-left:510px;">
    &nbsp;
