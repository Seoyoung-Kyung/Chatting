...
<div class="card" style="overflow: scroll; overflow-x: hidden">
  <h3 class='blue'><b>&nbsp; 기말성적 입력</b></h3><hr>

  <table>
      <thead>
        <tr>
            <form method="post" action="finalscoreInsertPro.jsp?s_id=<%=s_id%>&sub_id=<%=sub_id%>">
            <th scope="row">학번</th>
            <td><%=s_id%></td>
          </tr>
          <tr>
          ...
          <tr>
            <th scope="row">기말성적</th>
            <td><input type="number"  id="final_score" max="35" name="final_score" placeholder="35점 만점" autocomplete="off" required></td>
          </tr>
          <tr>
            <th scope="row">버튼</th>
