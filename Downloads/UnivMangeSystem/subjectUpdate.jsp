...
#sub_name, #credits, #sub_time, #sub_info {
  font-family: 'IBM Plex Sans KR', sans-serif;
  width: 180px;
  height: 29px;
  border-top:none;
...
<div class="card" style="overflow:scroll; height:410px;">
<div style="width:100%; float:center;">
    <h3 style="font-weight:bold;">&nbsp; 개설 과목 정보 수정
      <a href ="deptSubjectForm.jsp"><i class="fas fa-arrow-left" style="font-size:28px; color:rgb(54, 54, 54); float:right;">&nbsp;&nbsp;&nbsp;</i></a>
    </h3><hr>
  </div>    
    <form method="post" action="subjectUpdatePro.jsp?sub_id=<%=sub_id%>">
        <table class="type11">
            &nbsp;
            <tr>
            ...
            <tr>
               ...
               <td><input type="text" id = "sub_name" name="sub_name" autocomplete="off" placeholder="과목명" value="<%=sub_name%>"></td>
            </tr>
            <tr>
               <th scope="cols">학점</th>
               <td><input type="text" id = "credits" name="credits" autocomplete="off" placeholder="학점" value="<%=credits%>"></td>
            </tr>
            <tr>
               <th scope="cols">강의 시간</th>
               <td><input type="text" id = "sub_time" name="sub_time" autocomplete="off" placeholder="강의시간" value="<%=sub_time%>"></td>
            </tr>
            <tr>
               <th scope="cols">강의실</th>
               <td><input type="text" id = "sub_info" name="sub_info" autocomplete="off" placeholder="강의실" value="<%=sub_info%>"></td>
            </tr>
      </table>
